...
function ast_to_code(ast, comments) {
...
function deobfuscate_object_calls(ast) {
...
function deobfuscate_hidden_false(ast) {
...
function replace_with_actual_val(ast) {
...
function remove_comma_statements(ast) {
  traverse(ast, {
...
function remove_hex_numbers(ast) {
    traverse(ast, {
...
function remove_useless_if(ast) {
  traverse(ast, {
    IfStatement(path) {
